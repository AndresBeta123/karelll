...
public class Ascensor {
   ...
   /* public void cuandocaminar(){
    ...
    public static int maximo (ArrayList<Persona>personas,int opcion){
     int x = 0; 
     ...
     public static void cuandocaminar(City objetos,ArrayList<Persona>personas,int opcion,Robot estudiante){
        int y = 2;
         for(int i=0;i<personas.size();i++){
            ...
            if(personas.get(i).getX() == opcion ){
          caminar2(objetos,personas,i,personas.get(i).getX(),personas.get(i).getY()-1);
      ...
      opcion = 11 - y; 
       ...
       switch(opcion){
           ...
           case 1: 
                   ...
                   estudiante.turnLeft();
                  opcion = y;
                  baja(objetos,personas,opcion,maximo(personas,opcion),estudiante);
